...
export default function MatchWantSetting() {
  ...
  return (
    <View style={styles.matchContainer}>
      <View style={styles.TopView}>
        ...
        <Text style={styles.detailText}>상대 강아지 설정 변경</Text>
        </View>
      ...
      <Modal transparent={true} visible={isNeuteredModalVisible}>
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={{fontSize:15, fontWeight:'bold', marginTop:20}}>원하는 강아지의 중성화 여부를 선택해주세요</Text>
            <RadioButtonGroup
      ...
      <Modal transparent={true} visible={isPersonalityModalVisible}>
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={{fontSize:15, fontWeight:'bold', marginTop:20}}>원하는 강아지의 성격을 선택해주세요</Text>
